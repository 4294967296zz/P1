        ...
        ?>
            ...
            <table class="buttons">
                <thead>
                    <tr>
                        <th scope="col" class="no">
                            <form method="get" action="status_s.php">
                                <input type="submit" value="좌석"
                                   style="width:150px; height:60px; 
                                   border:1px; background-color: #B3B0B0;
                        ...
                        <th scope="col" class="no">
                            <form method="get" action="status_r.php">
                                <input type="submit" value="대여품"
                                   style="width:150px; height:60px; 
                                   border:1px; background-color: #B3B0B0;
                                   font-size:15pt; font-weight:bold">
                                <input type="hidden" name="page_no" value="0">
