...
<html>
    ...
    <body>
            ...
            <table class="board_1">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="type">물품명</th>
                        <th scope="col" class="sttime">대여 시간</th>
                        <th scope="col" class="extime">반납 시간</th>
                    </tr>
                    </thead>
                    <?php
        echo "<h1> 물품 대여 기록 <br><br>";
        $conn=mysqli_connect("localhost", "root", "dkssud1313!", "test_db");
        $sql="select count(*) from rental_log_db";
        ...
        $sql2="select * from rental_log_db where name like '%".$keyword."%' order by no desc limit ".$start_no.",".$record_per_page;
