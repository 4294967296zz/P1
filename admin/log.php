        ...
        <div id="wrapper"><center>
            ...
            <table class="buttons">
                <thead>
                    <tr>
                        <th scope="col" class="no">
                            <form method="get" action="reg_log.php">
                                <input type="submit" value="이용등록 기록"
                                   style="width:150px; height:60px; 
                                   border:1px;
                        ...
                        <th scope="col" class="no">
                            <form method="get" action="seat_log.php">
                                <input type="submit" value="좌석 이용기록"
                                   style="width:150px; height:60px; 
                                   border:1px;
                                   font-size:15pt; font-weight:bold">
                                <input type="hidden" name="page_no" value="0">
                    ...
                    <th scope="col" class="no" style="background-color: white;"></th>
                        <th scope="col" class="no">
                            <form method="get" action="rental_log.php">
                                <input type="submit" value="물품 이용기록"
                                   style="width:150px; height:60px; 
                                   border:1px;
                                   font-size:15pt; font-weight:bold">
                                <input type="hidden" name="page_no" value="0">
